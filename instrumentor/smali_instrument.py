...
#smali_dir = '/home/dosi/fuzzapk/smali-instrument/apk/rps-bb-test/rps-debug/smali-test/'
#smali_dir = '/home/dosi/08/contentProvider/apktool_out/smali-test/'

def is_smali_file(method_class_name, smali_dir):
    '''
...
def loc_method(method_name, method_descriptor, method_access_flag, method_class_smali_file, method_smali_file_path):
    '''
        ...
        :param method_smali_file_path: file path to new a smali file
...
def loc_basicblock(flag, ins, method_class_smali_file, newfilepath):
    '''
        ...
        :param ins: ins to locate, instrument after this ins. in detail, instument an ins after the first and last ins of a basicblock, or instrument after the one line bb
        :param method_class_smali_file: file object at the specific method location, for read
    ...
    #subline = 'invoke-static {}, Linstrument;->test()V'
