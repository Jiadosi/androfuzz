...
def get_params_dosi(proto):
    '''
        return params length
        :param proto: method.get_descriptor()
        :rtype: length of params
    '''
    ret = proto.split(')')
    params = ret[0][1:].split()
    if params:
...
#method_class_name: class contains this method
#method_name: name of this method
#method_descriptor: rtype of this method
...
def get_bytecodes_methodx(method, mx, smali):
    ...
    if method.code is not None:
        ...
        #dosi: open smali file and locate the method
